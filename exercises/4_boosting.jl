...
let	
	cut_values = range(0.0, 1.0, length=101)
	...
	for cut in cut_values
		...
		push!(bkg_effs_gb, fom_for_cut(tbkg_val,tbkg_val,"gbdt",cut,(s,b)->b,nsig=1, nbkg=1))
	end
